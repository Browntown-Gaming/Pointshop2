...
ITEM.PrintName = "[500,000] Premium Point Conversion"
ITEM.Description = "Activating this gives you the equivalent amount (500,000) of standard points. Careful, you can't convert them back!"
ITEM.baseClass = "base_single_use"
ITEM.category = "Misc"

ITEM.Price = {
	premiumPoints = 500000,
}
...
--Give points on use
function ITEM:OnUse( )
	self:GetOwner():PS2_AddStandardPoints(500000)
end
