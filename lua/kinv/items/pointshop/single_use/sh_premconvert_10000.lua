...
ITEM.PrintName = "[10,000] Premium Point Conversion"
ITEM.Description = "Activating this gives you the equivalent amount (10,000) of standard points. Careful, you can't convert them back!"
...
--Give points on use
function ITEM:OnUse( )
	self:GetOwner():PS2_AddStandardPoints(10000)
end
