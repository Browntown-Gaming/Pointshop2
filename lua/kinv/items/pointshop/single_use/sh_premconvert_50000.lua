...
ITEM.PrintName = "[50,000] Premium Point Conversion"
ITEM.Description = "Activating this gives you the equivalent amount (50,000) of standard points. Careful, you can't convert them back!"
...
--Give points on use
function ITEM:OnUse( )
	self:GetOwner():PS2_AddStandardPoints(50000)
end
